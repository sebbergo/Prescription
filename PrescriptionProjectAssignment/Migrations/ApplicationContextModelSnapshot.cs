            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "yeLGPLOABLSIQ/aFHEjCPjKuyNuMQJUH4K+9LCY3QfE=",
                            RoleId = 1
                        },
                        new
                        {
                            ...
                            FirstName = "Sumit",
                            LastName = "Sumit",
                            Password = "B3k1YrDkGP/wZPJ+lfFOuXuFIMXSfI4vm9zhimZjPjg=",
                            RoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Medicine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 2,
                            ExpirationDate = new DateTime(2022, 4, 2, 13, 50, 14, 358, DateTimeKind.Local).AddTicks(227),
                        ...
                        new
                        {
                            Id = 2,
                            Amount = 2,
                            ExpirationDate = new DateTime(2022, 4, 2, 13, 50, 14, 360, DateTimeKind.Local).AddTicks(6684),
                            Instructions = "Take one daily",
                            Name = "Cialis"
                        });
                });
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Patient1",
                            LastName = "Panda",
                            Password = "XS9im50aMHuFO4aD02k3WZ7ompsRByvsQdhAeivkTgo=",
                            RoleId = 3
                        },
                        new
                        {
                            ...
                            FirstName = "Patient2",
                            LastName = "Ko",
                            Password = "NgKirHYLzgL4dz+WwnHmCTLOreQ6rxR+90/y7zKXAic=",
                            RoleId = 3
                        });
                });
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Pharmaceut", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Phillip",
                            LastName = "Andersen",
                            Password = "EcJ6waGTnXfzIo8hEUNNFerRzSsGNTFXAcEIEwH0GVE=",
                            PharmacyId = 1,
                            RoleId = 2
                        },
                        new
                        {
                            ...
                            FirstName = "Sebastian",
                            LastName = "Hansen",
                            Password = "9zcBGItxl1LI8EAQ4SFMNzBnnYBxz+Ce60p12Vn68Qc=",
                            PharmacyId = 2,
                            RoleId = 2
                        });
                });
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 3, 3, 13, 50, 14, 360, DateTimeKind.Local).AddTicks(7973),
                            DoctorId = 1,
                            MedicineId = 1,
                            Name = "Test",
                            PatientJournalId = 1
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 3, 3, 13, 50, 14, 360, DateTimeKind.Local).AddTicks(9208),
                            DoctorId = 2,
                            MedicineId = 2,
                            Name = "Test",
                            PatientJournalId = 2
